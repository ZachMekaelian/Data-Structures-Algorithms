...
{ 
  ...
  // 6. insert the 9th  (element 12) error (out of range)
    ...
    catch(int y){ cout << "error(out of range)" << endl; }  // do not exit
  ...
  // 12. delete Ith I==5 . error (out of range)
    ...
    catch(int y){ cout << "error (out of range)" << endl; }
...
void caseThree()
{
  ...
  //**
  L1.addFront(1); L1.addRear(2); L1.addRear(3); L1.addRear(4); L1.addRear(5);
 ...
 cout << "-- After copytest --- " << endl;
  ...
  cout << "Step " << counter << endl; counter++;
 //**
  L2.addFront(7); L2.addRear(8); L2.addRear(9); L2.addRear(10);
  //7. Display L2
  cout << "Step " << counter << endl; counter++;
