...
// This application adds/modify/delete elements into a HashTable.
int main()
{ 
  // ** // cout an explanation of what this App should be used for. 
  cout << "This application adds/modify/delete elements into a HashTable." << endl;
    ...
    case 1:  // Add and indicate slot
     {
      ...
      cin >> thename;
      cout << "What is the department?" ;
      cin >> department; //  Here get two more pieces of info
      cout << "What is the age? ";
      cin >> age;
      el_t e(thekey, thename, department, age);//  Create the element with all the info 
      s = HT.add(e);
